        ...
        <div className="flex flex-col gap-3.5 p-5">
          <div className="grid gap-4 sm:grid-cols-[120px_1fr]">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Field name="price" label={t({ ka: "ფასი", en: "Price" })} type="number" defaultValue={product.price} className={`${FIELD} font-mono`} />
              <Field name="size" label={t({ ka: "ზომა", en: "Size" })} defaultValue={product.size ?? ""} />
            </div>
          </div>
          <div className="grid grid-cols-3 gap-3">
            <Field name="discountPct" label={t({ ka: "ფასდაკლება %", en: "Discount %" })} type="number" defaultValue={product.discountPct ?? ""} />
            <Field name="salePrice" label={t({ ka: "ფასდაკლ. ფასი", en: "Sale price" })} type="number" defaultValue={product.salePrice ?? ""} className={`${FIELD} font-mono`} />
