...
export function TesterSection() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <AiModuleNotice
        text={{
          ka: "ქვემოთ ნაჩვენებია სატესტო მაგალითი. ლაივ პასუხების გენერაცია საჭიროებს AI მოდულს.",
          en: "The exchange below is a sample. Generating live replies requires the AI module.",
        }}
      />
