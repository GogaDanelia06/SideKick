...
const REGISTER_VALIDATION_MESSAGES = {
  ...
  passwordLetter: {
    ka: "პაროლი უნდა შეიცავდეს მინიმუმ ერთ ასოს",
    en: "Password must contain at least one letter",
  },
  passwordNumber: {
    ka: "პაროლი უნდა შეიცავდეს მინიმუმ ერთ ციფრს",
...
export function RegisterForm() {
  ...
  async function onSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    else if (password.length < 8) errors.password = "passwordLength";
    else if (!/[A-Za-zა-ჰ]/.test(password)) errors.password = "passwordLetter";
        ...
        <form className="flex flex-col gap-3.5" onSubmit={onSubmit} noValidate>
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            <Field
              ...
              error={fieldErrors.firstName ? t(REGISTER_VALIDATION_MESSAGES[fieldErrors.firstName]) : undefined}
            ...
            <Field
              ...
              error={fieldErrors.lastName ? t(REGISTER_VALIDATION_MESSAGES[fieldErrors.lastName]) : undefined}
          ...
          <Field
            ...
            type="email"
            autoComplete="email"
            error={fieldErrors.email ? t(REGISTER_VALIDATION_MESSAGES[fieldErrors.email]) : undefined}
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            <Field
              ...
              error={fieldErrors.password ? t(REGISTER_VALIDATION_MESSAGES[fieldErrors.password]) : undefined}
            ...
            <Field
              ...
              type="password"
              autoComplete="new-password"
              error={fieldErrors.repeatPassword ? t(REGISTER_VALIDATION_MESSAGES[fieldErrors.repeatPassword]) : undefined}
          ...
          <Field
            ...
            type="tel"
            autoComplete="tel"
            error={fieldErrors.phone ? t(REGISTER_VALIDATION_MESSAGES[fieldErrors.phone]) : undefined}
          ...
          <Field
            ...
            error={fieldErrors.company ? t(REGISTER_VALIDATION_MESSAGES[fieldErrors.company]) : undefined}
          ...
          <Field
            ...
            hint={t(REGISTER.optional)}
            type="text"
            error={fieldErrors.field ? t(REGISTER_VALIDATION_MESSAGES[fieldErrors.field]) : undefined}
