...
export function verifyEmailEmail(to: string, link: string, name?: string | null): Mail {
  const greeting = name ? `გამარჯობა, ${name}!` : "გამარჯობა!";

  const text = [
    greeting,
    "",
    "კეთილი იყოს თქვენი მობრძანება Sidekick-ში.",
    "ანგარიშის გასააქტიურებლად დაადასტურეთ ელფოსტა ამ ბმულით:",
    "",
    link,
    "",
    "ბმული აქტიურია 24 საათის განმავლობაში.",
    "თუ არ დარეგისტრირებულხართ — უბრალოდ დააიგნორეთ ეს წერილი.",
    "",
    "— Sidekick",
  ].join("\n");
...
<div style="font-family:system-ui,-apple-system,'Segoe UI',sans-serif;max-width:520px;margin:0 auto;padding:24px;color:#1f2328;line-height:1.6">
  <div style="font-size:20px;font-weight:600;margin-bottom:16px">Sidekick</div>
  <p>${greeting}</p>
  <p>კეთილი იყოს თქვენი მობრძანება. ანგარიშის გასააქტიურებლად დაადასტურეთ ელფოსტა:</p>
  <p style="margin:24px 0">
    <a href="${link}" style="background:#1f883d;color:#fff;text-decoration:none;padding:12px 22px;border-radius:8px;font-weight:500;display:inline-block">
  ...
  <p style="font-size:13px;color:#59636e">
    ბმული აქტიურია <b>24 საათის</b> განმავლობაში.
  </p>
  <p style="font-size:13px;color:#59636e">
    თუ არ დარეგისტრირებულხართ — უბრალოდ დააიგნორეთ ეს წერილი.
  </p>
  ...
  return { to, subject: "დაადასტურე ელფოსტა — Sidekick", html, text };
}
